...
public:
    ...
    int unifvec3; //handle for uniform vec3 to represent camera position in world space
...
public:
    ...
    //Update camera position relative to uniform vec3
    void updateCam(const glm::vec3 &cam);
};
